...
def generate_hashtags_deepseek(player_name, event, deepseek, previous_guesses = None, current_round = 1, description = None):
    """
...
class HashtagMessagePassing(Environment):
    ...
    def step(self, player_name: str, action: str) -> TimeStep:
        ...
        if self.cur_round == 1:
            chosen_hashtag, description = generate_hashtags_deepseek(player_name, self.event, self.deepseek)
            ...
            chosen_hashtag, description = generate_hashtags_deepseek(player_name, self.event, self.deepseek, previous_guesses, self.cur_round)
            ...
            chosen_hashtag, description = generate_hashtags_deepseek(player_name, self.event, self.deepseek, previous_guesses, self.cur_round,description_for_guess)
    ...
    def coordination(self):
        ...
        plt.legend()
        plt.grid(True)
        plt.savefig("noeffect_coordination_plot_1.png")
    ...
    def colormap(self):
        ...
        plt.savefig("noeffect_colormap_1.png")
